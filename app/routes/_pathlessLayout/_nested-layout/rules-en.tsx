      ...
      <details className="group w-full">
        ...
        <div className="prose dark:prose-invert prose-neutral mt-4 px-3 pb-4 max-w-none">
          <ul>
            ...
            <li>
              Mods are free to accept bribes and collude, but may be called out
              and excluded
            </li>
        ...
        <details className="group w-full">
          ...
          <div className="prose dark:prose-invert prose-neutral mt-4 px-3 pb-4 max-w-none">
            <ul>
              ...
              <li>
                I received zero tokens at launch, and traded against snipers to
                get my allocation. I market buy more tokens with all my trading
                fees.
              </li>
              <li>
                Swap your tokens; do whatever you want with them. I will market
                buy whatever I give out.
              </li>
            </ul>
          </div>
        </details>
